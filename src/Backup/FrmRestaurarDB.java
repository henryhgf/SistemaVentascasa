...
class MyFilter extends javax.swing.filechooser.FileFilter {
  ...
  public boolean restoreDB(String dbUserName, String dbPassword, String source) {
    ...
    private void initComponents() {
        ...
        btnRestaurar.setBounds(140, 160, 100, 90);

        txtRuta.setEditable(false);
        getContentPane().add(txtRuta);
        txtRuta.setBounds(140, 30, 220, 30);
        ...
        btnSeleccionar.setBounds(380, 30, 110, 30);

        txtUsuario.setText("root");
        getContentPane().add(txtUsuario);
        txtUsuario.setBounds(140, 70, 150, 30);
        ...
        jLabel5.setBounds(30, 30, 110, 30);
        ...
        txtContraseña.setBounds(140, 110, 150, 30);
        ...
        jButton1.setBounds(240, 160, 100, 90);
